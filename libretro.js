...
function setupFileSystem(backend)
{
   ...
   var xfs3 =  new BrowserFS.FileSystem.XmlHttpRequest
      (".index-xhr", "assets/cores/_roms/");

   var xfs4 =  new BrowserFS.FileSystem.XmlHttpRequest
      (".index-xhr", "assets/cores/_bios/");

   console.log("WEBPLAYER: initializing filesystem: " + backend);
   mfs.mount('/home/web_user/retroarch/userdata', afs);

   mfs.mount('/home/web_user/retroarch/bundle', xfs1);
   mfs.mount('/home/web_user/retroarch/userdata/content/roms', xfs3);
   mfs.mount('/home/web_user/retroarch/userdata/system', xfs4);
